                            ...
                            <td>
                                <div style="width: 100%; padding-left: 5vh; padding-right: 5vh;">
                                    <p style="color: black; font-size: 1.3rem; text-align: justify;">
                                        <b>{{$name}}</b> agradecemos su preferencia, en este correo se encuentra adjunta su referencia de pago
                                        <strong><b>la cuál tiene una vigencia de 48 horas<b></strong> por lo cuál le pedimos realice su pago 

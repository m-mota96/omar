<div class="container mt-5 mb-5 footer">
    <div class="row">
        <hr class="w-100 mb-2">
        <div class="col-xl-4">
            <span class="font-small"><a class="text-dark" href="">Términos y condiciones</a></span> &nbsp;
            <span class="font-small"><a class="text-dark" href="">Políticas de privacidad</a></span>
        </div>
        <div class="col-xl-4 text-center pt-4">

                ...
                <div class="row pr-3" id="divEvents">
                    @foreach ($events as $e)
                        ...
                        <div class="col-xl-8 bg-white p-4 mb-4">
                            <div class="row">
                                <div class="col-xl-8">
                                    <h4 class="bold mb-0"><a class="text-dark" href="{{route('admin.edit', $e->id)}}">{{$e->name}}</a></h4>
                                    <span>
                                        {{$e->initial_date}} a 
                                        {{$e->final_date}}
                                    </span>
                                    <p></p>
                                    <span class="font-small mr-4"><a class="text-dark" href="{{route('admin.edit', $e->id)}}">EDITAR</a></span>
